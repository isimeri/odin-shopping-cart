      ...
      <div className="home-inner">
        <div className="homepage-left">
          <div className="vwrapper">
            <h1 className="title" data-testid="title">GameBruh</h1>
          ...
          <p className="developer" data-testid="developer">Developed by <a href="https://github.com/isimeri" target='_blank'>isimeri</a></p>
        </div>
        <div className="homepage-right">
          <Link to="/store">Go to store</Link>
        </div>
      </div>
      <video className='video-wallpaper' data-testid="video-wallpaper" autoPlay loop muted playsInline>
